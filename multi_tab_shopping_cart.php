<?php   
 ...
 <html>  
      <head>  
      <title>e-kart</title> 
    <link href="multi.css" rel="stylesheet" text="text/css" />
    ...
    <link rel="shortcut icon" href="favicon.png" />
     ...
     <nav>
        <div class="containers">
            ...
            <li class="actives"><i class="fa fa-shopping-cart" aria-hidden="true"></i><a href="index.php">Store</a></li>
            <ul>
           ...
           <div class="container" style="width:800px;">  
                <h3 align="center">E-kart shopping list</h3><br />  
